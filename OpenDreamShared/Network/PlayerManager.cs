...
public class PlayerManger : IPlayerManager {
    public ICommonSession[] Sessions => throw new NotImplementedException();

    public ICommonSession[] NetworkedSessions => throw new NotImplementedException();

    public IReadOnlyDictionary<NetUserId, ICommonSession> SessionsDict => throw new NotImplementedException();

    public int PlayerCount => throw new NotImplementedException();

    public int MaxPlayers => throw new NotImplementedException();

    public ICommonSession? LocalSession => throw new NotImplementedException();

    public NetUserId? LocalUser => throw new NotImplementedException();

    public EntityUid? LocalEntity => throw new NotImplementedException();
    ...
    public bool SetAttachedEntity([NotNullWhen(true)] ICommonSession? session, EntityUid? entity, out ICommonSession? kicked, bool force = false) {
        throw new NotImplementedException();
    }
    ...
    public void UpdateState(ICommonSession commonSession) {
        throw new NotImplementedException();
    }
}
