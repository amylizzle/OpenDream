...
public class GameTiming : IGameTiming {
    ...
    private readonly Stopwatch _realTimer = new Stopwatch();
    ...
    public TimeSpan CurTime {
        get {
            ...
            time += TickPeriod.Multiply(CurTick.Value - lastTimeTick.Value);
    ...
    private void CacheCurTime(GameTick atTick) {
        ...
        var newTime = cachedTime + TickPeriod.Multiply(atTick.Value - lastTimeTick.Value);
