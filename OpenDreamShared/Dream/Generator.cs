...
public interface IGenerator {
    public static float GenerateNum(SeededRandom random, float low, float high, GeneratorDistribution distribution) {
...
public interface IGeneratorNum : IGenerator {
    public float Generate(SeededRandom random);
}

public interface IGeneratorVector : IGenerator {
    bool PrefersVector3 { get; set; }
    public Vector2 GenerateVector2(SeededRandom random);
    public Vector3 GenerateVector3(SeededRandom random);
}
